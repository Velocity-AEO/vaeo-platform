...
// ── GET — return active email capture component ─────────────────────────────
...
export async function GET() {
  ...
  return NextResponse.json({
    component: {
      ...
      status: 'active',
      config,
      snippet_name: 'vaeo-email-capture',
      render_tag: "{%- render 'vaeo-email-capture' -%}",
      version: '1.0.0',
