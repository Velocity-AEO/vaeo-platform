...
function getMockRun(siteId: string): HeavyweightRun & {
  ...
  return {
    ...
    regression_check: {
      ...
      violations:    [],
      rules_checked: 6,
      scores_before: { performance: 0, accessibility: 0, best_practices: 0, seo: 0 },
      scores_after:  { performance: 0, accessibility: 0, best_practices: 0, seo: 0 },
      budget_status: { load_ms_ok: true, main_thread_ms_ok: true, network_requests_ok: true, load_ms_remaining: 0, main_thread_ms_remaining: 0, network_requests_remaining: 0, all_budgets_ok: true },
      recommendation: '',
    },
